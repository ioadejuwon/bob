...
$(document).ready(function() {
    ...
    function handleQuantityChange(productId, newQty) {
        ...
        if (itemIndex !== -1) {
            ...
            console.log(`Updated quantity for product ID ${productId} to ${newQty}`); // Debug log
            updateCartInLocalStorage();
        } else {
            console.log(`Product ID ${productId} not found in cart`); // Debug log
        }
    }
    ...
    $('.cart-items-container').on('click', '.input-counter__up', function() {
        const itemRow = $(this).closest('tr'); // Adjust selector if needed
                ...
                <td>
                    <div class="input-counter  js-input-counter">
                        ...
                        <div class="input-counter__controls">
                            <button class='input-counter__down js-down'>
                                <i class='icon' data-feather="minus"></i>
                            </button>

                            <button class='input-counter__up js-up'>
