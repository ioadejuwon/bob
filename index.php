...
?>
    ...
    <div class="content-wrapper  js-content-wrapper">
      ...
      <section data-anim-wrap class="mainSlider -type-1 js-mainSlider">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div data-anim-child="fade" class="mainSlider__bg">
              <div class="bg-image js-lazy" data-bg="assets/img/home-2/mainSlider/bg.png"></div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row justify-center text-center" style="padding-bottom:10%">
        ...
        <button class="d-none swiper-prev button -white-20 text-white size-60 rounded-full d-flex justify-center items-center js-prev" style="display: none !important;">
          <i class="icon icon-arrow-left text-24"></i>
        </button>

        <button class="d-none swiper-next button -white-20 text-white size-60 rounded-full d-flex justify-center items-center js-next" style="display: none !important;">
      ...
      <div class="d-none" style="padding-top: 2%;;">
        <section data-anim-wrap class="masthead -type-2">
          <div class="masthead__bg">
            <div class="bg-image js-lazy" data-bg="assets/img/home-3/masthead/bg.png"></div>
          </div>
